...
def cmtl2stl(cmtl_ast):
    ...
    set of atomic propositions and the set of capabilities in the CMTL formula.
    ...
    ``z_{\pi,c} \geq n''. Thus, a CMTL task is translated to STL as follows
    ...
    if cmtl_ast.op == CMTLOperation.BOOL:
        ...
        var = cmtl_ast.proposition + '_{cap}'
        conjunction_terms = \
        ...
        children = [cmtl2stl(ch) for ch in cmtl_ast.children]
