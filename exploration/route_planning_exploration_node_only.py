...
def add_reward_exploration_obj(m, ts, time_bound, prob_map, alpha, agent_classes, agents):
...
def route_planning(ts, agents, formula, belief_resources, prob_map, alpha, time_bound=None, variable_bound=None,
    ...
    add_reward_exploration_obj(m, ts, time_bound, prob_map, alpha, agent_classes, agents)
    # run optimizer
