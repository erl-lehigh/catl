...
def setup_logging(logfile='uni_indiv.log', loglevel=logging.DEBUG,
...
def case_simple(ts_filename='construction.yaml'):
    ...
    m = route_planning(ts, agents, specification, storage_type=storage_type,
                       ...
                       resource_type='indivisible', travel_time_weight=0.3, resources_weight=0.3,
                       transportation=True)     
    end = time.time()                  
    time_ = end - start
    ...
    print('Time needed for Uniform-indivisible method: ', time_)
